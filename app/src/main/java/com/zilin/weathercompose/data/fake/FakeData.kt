...
object FakeData {
    ...
    val aboutStr = "知心天气 - 您贴心的天气小管家\n" +
            "        \n在天气变幻莫测的世界里，您是否渴望拥有一款精准、便捷又实用的天气预报 APP？知心天气正是这样一款能满足您需求的天气应用，为您的生活增添更多从容与安心。\n" +
            "    \n精准预报，洞悉天气变化\n" +
            "        \n知心天气采用先进的气象数据算法和多源数据融合技术，为您提供高精度的天气预报。无论是实时气温、空气质量、湿度、风速风向，还是未来 24 小时逐小时预报、15 天长期天气预报，都能精准呈现。让您提前规划出行、安排活动，再也不用担心被突如其来的天气打乱计划。\n" +
            "        \n城市随心切换，天气尽在掌握\n" +
            "        \n您可以轻松添加多个关注城市，一键切换查看不同城市的天气状况。对于经常出差或旅行的人士来说，知心天气就像您的随行气象员，随时随地为您提供目的地的天气详情。\n" +
            "        \n界面简洁直观，操作便捷流畅\n" +
            "        \n知心天气秉持简洁至上的设计理念，界面布局清晰明了，色彩搭配柔和舒适。主要天气信息一目了然，各项功能按钮布局合理，即使是初次使用的用户也能快速上手。流畅的操作体验，让您在查看天气时更加得心应手。"
